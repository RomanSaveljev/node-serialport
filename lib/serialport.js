 ...
 * @description Writes data to the given serial port. Buffers written data if the port is not open.
...
/**
 * @description Request a number of bytes from the SerialPort. The `read()` method pulls some data out of the internal buffer and returns it. If no data available to be read, null is returned. By default, the data will be returned as a Buffer object unless an encoding has been specified using the `.setEncoding()` method.
...
SerialPort.prototype._read = function(bytes) {
  ...
  // this.binding.startReading(bytes);
};
